...
\begin{figure}[H]
    ...
    \caption{Image (a) shows the first approach on the Acceleration track, while image (b) shows the second approach drawing a middle line. Approach (b) has middle point between the calculated triangulation and interpolates based on the middle points.}
...
\begin{figure}[H]
    ...
    \caption{The calculation of the middle line on the Skidpad track. It is visible that it can handle the track with some problems while driving the straight line in the middle. The algorithm also made some shortcuts while driving into the straight line in the middle of the track.}
...
Figure \ref{fig:Result Small Track First Approaches} shows the progression of the improvements from the first implementation of the algorithm (a) to the second improved version of the algorithm (b) and to the final implementation of the algorithm in figure \ref{fig:Result Small Track Final}. Again, for the first and second approaches, the implementation of publishing the start and end cones (big orange cones) was not made. It is visible that the final implemenation can handle the curve on the bottom left corner more smoothly.
\begin{figure}[H]
    \centering
    \includegraphics[width=\columnwidth]{Result_SmallTrack_First_Approaches.png}
    \caption{The progression of the improvements of the first implementation (a) to the second implementation (b) is shown. The difference in the (a) and (b) implementation is the points between the calculated triangulation and the interpolated middle line.}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{Results_Optimization_Small_Track_Laps_2_Shortest_Path.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{Results_Optimization_Small_Track_Laps_2.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{Results_Optimization_Small_Track_Laps_2_Mincurv_IQP.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{Results_Optimization_Small_Track_Laps_2_VelAcc_Profile.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{Results_Optimization_Small_Track_Laps_2_Curv_Profile.png}
    \caption{The Curvature Profile on Small Track for two laps.}
    \label{fig:Results Small Track Laps 2 Curv Profile}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{Results_Optimization_Small_Track_Laps_2_3D_Vel_Profile.png}
    \caption{The 3D Velocity Profile on Small Track for two laps.}
    \label{fig:Results Small Track Laps 2 3D Vel Profile}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{Results_Optimization_Small_Track_Laps_2_Spline_Normals.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{Results_Optimization_Rand_Laps_2_Shortest_Path.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{Results_Optimization_Rand_Laps_2.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{Results_Optimization_Rand_Laps_2_Mincurv_IQP.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{Results_Optimization_Rand_Laps_2_VelAcc_Profile.png}
    \caption{The Velocity and Acceleration Profile on Rand for two laps.}
    \label{fig:Results Rand Laps 2 VelAcc Profile}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{Results_Optimization_Rand_Laps_2_Curv_Profile.png}
    \caption{The Curvature Profile on Rand for two laps.}
    \label{fig:Results Rand Laps 2 Curv Profile}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{Results_Optimization_Rand_Laps_2_3D_Vel_Profile.png}
    \caption{The 3D Velocity Profile on Rand for two laps.}
    \label{fig:Results Rand Laps 2 3D Vel Profile}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{Results_Optimization_Rand_Laps_2_Spline_Normals.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{Results_Optimization_Comp_2021_Laps_2_Shortest_Path.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{Results_Optimization_Comp_2021_Laps_2.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{Results_Optimization_Comp_2021_Laps_2_VelAcc_Profile.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{Results_Optimization_Comp_2021_Laps_2_Curv_Profile.png}
    \caption{The Curvature Profile on the ``Competition 2021'' track for two laps.}
    \label{fig:Results Comp 2021 Laps 2 Curv Profile}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{Results_Optimization_Comp_2021_Laps_2_3D_Vel_Profile.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{Results_Optimization_Comp_2021_Laps_2_Spline_Normals.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{Results_Optimization_Garden_Light_Laps_2_Shortest_Path.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{Results_Optimization_Garden_Light_Laps_2.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{Results_Optimization_Garden_Light_Laps_2_VelAcc_Profile.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{Results_Optimization_Garden_Light_Laps_2_Curv_Profile.png}
    \caption{The Curvature Profile on the Garden Light track for two laps.}
    \label{fig:Results Garden Light Laps 2 Curv Profile}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{Results_Optimization_Garden_Light_Laps_2_3D_Vel_Profile.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{Results_Optimization_Garden_Light_Laps_2_Spline_Normals.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{Results_Optimization_Rounded_Rectangle_Laps_2_Shortest_Path.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{Results_Optimization_Rounded_Rectangle_Laps_2.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{Results_Optimization_Rounded_Rectangle_Laps_2_Mincurv_IQP.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{Results_Optimization_Rounded_Rectangle_Laps_2_VelAcc_Profile.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{Results_Optimization_Rounded_Rectangle_Laps_2_Curv_Profile.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{Results_Optimization_Rounded_Rectangle_Laps_2_Spline_Normals.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{Results_Optimization_Handling_Track_Laps_2_Shortest_Path.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{Results_Optimization_Handling_Track_Laps_2.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{Results_Optimization_Handling_Track_Laps_2_Mincurv_IQP.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{Results_Optimization_Handling_Track_Laps_2_VelAcc_Profile.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{Results_Optimization_Handling_Track_Laps_2_Curv_Profile.png}
    \caption{The Curvature Profile on the Handling Track for two laps.}
    \label{fig:Results Handling Track Laps 2 Curv Profile}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{Results_Optimization_Handling_Track_Laps_2_Spline_Normals.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{Results_Optimization_Berlin_2018_Laps_2_Shortest_Path.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{Results_Optimization_Berlin_2018_Laps_2.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{Results_Optimization_Berlin_2018_Laps_2_Mincurv_IQP.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{Results_Optimization_Berlin_2018_Laps_2_VelAcc_Profile.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{Results_Optimization_Berlin_2018_Laps_2_Curv_Profile.png}
    \caption{The Curvature Profile on the Berlin 2018 track for two laps.}
    \label{fig:Results Berlin 2018 Laps 2 Curv Profile}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{Results_Optimization_Berlin_2018_Laps_2_Spline_Normals.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{Results_Optimization_Modena_2019_Laps_2.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{Results_Optimization_Modena_2019_Laps_2_Mincurv_IQP.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{Results_Optimization_Modena_2019_Laps_2_VelAcc_Profile.png}

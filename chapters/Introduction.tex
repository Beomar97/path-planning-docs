...
The first implementation of a path planning algorithm in the team of \acrlong{zur} consisted of middle line detection, path smoothening, and a velocity/acceleration profile. To evaluate the middle line of the track, Delaunay-Triangulation was used. An error rate was considered e.g. when a cone wasn't detected. The implementation did not cover an algorithm that draws the optimum line in consideration of curves and speed. Furthermore, the overall software architecture must be made simpler and easier to understand, so future team members can improve on the work that was made before.

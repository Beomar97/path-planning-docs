...
\section{Custom ROS Messages} \label{sec:Custom ROS Messages}
...
\section{Path Planner Node} \label{sec:Path Planner Node}
...
\section{Optimization Input Transformer} \label{sec:Optimization Input Transformer}
